...
| [result-archive/](result-archive/INDEX.md) | Result archive format |
...
| [design/](design/) | Tampermonkey UI pattern library |

## Referenced by

- `resources/INDEX.md` → Reference section
- `AGENTS.md` → Quick reference (General reference row)
